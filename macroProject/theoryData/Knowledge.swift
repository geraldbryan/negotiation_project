...
struct KnowledgeList{
    ...
    static let knowledgeData = [
        ...
        Knowledge(
            ...
            color: "green_tone",
            urlText: "https://www.waldenu.edu/programs/communication/resource/ten-dos-and-donts-of-business-negotiating",
            url: URL(string: "https://www.waldenu.edu/programs/communication/resource/ten-dos-and-donts-of-business-negotiating")!),
        Knowledge(
            icon: "xmark",
            textIcon: "Dont's",
            image: "DontButton",
